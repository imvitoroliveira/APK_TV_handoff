...
export const VideoProvider = ({ children }: { children: ReactNode }) => {
  ...
  const playVideo = useCallback((url: string, media?: PlayingMedia) => {
    ...
    // No APK, sempre usar o player interno. O modo V1 dependia de
    // window.open, que não é confiável dentro do WebView Android.
    if (version === 'v1' && !Capacitor.isNativePlatform()) {
